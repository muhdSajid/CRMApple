                    ...
                    <>
                      <div className="p-2 border-b border-gray-100 dark:border-gray-700">
                        <div className="flex gap-1">
                          ...
                          >
                            <PrivilegeGuard privileges={[PRIVILEGES.MEDICINE_DISTRIBUTION_CENTER_ADD, PRIVILEGES.MEDICINE_DISTRIBUTION_ALL, PRIVILEGES.ALL]}>
                  ...
                  <TableRow className="bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800">
                      ...
                      <div className="relative patient-search-dropdown-container">
                        <div className="flex gap-2">
                          ...
                          {distributionList.length === 0 && (
                            ...
                            >
                              <PrivilegeGuard privileges={[PRIVILEGES.MEDICINE_DISTRIBUTION_PATIENT_ADD, PRIVILEGES.MEDICINE_DISTRIBUTION_ALL, PRIVILEGES.ALL]}>
                    ...
                    <TableCell className="py-3 text-center">
                      <div className="flex gap-1 justify-center">
                        {/* Add Medicine button */}
                        <PrivilegeGuard privileges={[PRIVILEGES.MEDICINE_DISTRIBUTION_CREATE, PRIVILEGES.MEDICINE_DISTRIBUTION_ALL, PRIVILEGES.ALL]}>
                          <button
